...
export function Heading({ className, as: Element = 'h2', dark = false, ...props }) {
  return (
    <Element
      ...
      className={clsx(
        className,
        'text-pretty text-4xl font-normal tracking-tighter text-gray-950 data-dark:text-white sm:text-6xl',
      )}
    />
  )
}
...
export function Subheading({ className, as: Element = 'h2', dark = false, ...props }) {
  return (
    <Element
      ...
      className={clsx(
        className,
        'font-inter text-xs/5 font-normal uppercase tracking-widest text-gray-500 data-dark:text-gray-400',
      )}
    />
  )
}
